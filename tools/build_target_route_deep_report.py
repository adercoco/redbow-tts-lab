...
<main>
  ...
  <p><b>已補 smoke 對照：</b><a href="../qwen_base_clone_vs_cosy_smoke_v1/qwen_base_clone_vs_cosy_smoke_v1_standalone.html">Qwen Base clone vs Cosy clone smoke v1</a>。這版用同一份 <code>pack_best2_7s.wav</code> reference，同三句台詞比較 CosyVoice2 和 Qwen3-TTS 0.6B Base clone。</p>
  <table class="compact-table">
