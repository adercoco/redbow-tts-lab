...
<main>
  ...
  <div class="route-map">
    <section class="route-lane">
      ...
      <div class="route-body">
        ...
        <div class="route-arrow">↓</div>
        <div class="route-node"><b>3. Qwen Base clone 對照</b><small>改用 Qwen Base clone 模型，已用同一份女聲 reference 跑 0.6B / 1.7B，和 Cosy 公平比較。</small></div>
      </div>
    </section>
    <section class="route-lane">
  ...
  <p>我們已經用本機 <code>0.6B-Base-4bit</code> 與新下載的 <code>1.7B-Base-4bit</code> 做 smoke test。公平比較方式是餵 Cosy 用過的同一份 reference dataset，產同一批句子，再用同一套 speaker cosine / ASR / 聽感排序。</p>
  <p><b>已補 smoke 對照：</b><a href="../qwen_base_clone_vs_cosy_smoke_v1/qwen_base_clone_vs_cosy_smoke_v1_standalone.html">Qwen Base clone vs Cosy clone smoke v1</a>。這版用同一份 <code>pack_best2_7s.wav</code> reference，同三句台詞比較 CosyVoice2、Qwen3-TTS 0.6B Base clone、Qwen3-TTS 1.7B Base clone。</p>
  <table class="compact-table">
